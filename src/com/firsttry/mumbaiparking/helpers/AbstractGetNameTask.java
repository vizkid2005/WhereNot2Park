...
/*
 * ATTENTION : THIS CLASS IS USED BY THE GoogleLoginActivity.java in the main folder
...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void>{
    ...
    AbstractGetNameTask(GoogleLoginActivity activity, String email, String scope) {
    	Log.i("Flow-AbstractGetNameTask","AbstractGetNameTask constructor");
    ...
    protected Void doInBackground(Void... params) {
      try {
    	  Log.i("Flow-AbstractGetNameTask","doInBackground");
    ...
    private String getFirstName(String jsonResponse) throws JSONException {
      ...
      Log.i("JSON OBJECT",profile.toString());
