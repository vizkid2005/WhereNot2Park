...
import com.firsttry.mumbaiparking.GoogleLoginActivity;
...
public class GetNameInForeground extends AbstractGetNameTask {
  ...
  public GetNameInForeground(GoogleLoginActivity activity, String email, String scope) {
      ...
      Log.i("Flow-GetNameinForeground","GetNameInForeground constructor");
  }
  ...
  protected String fetchToken() throws IOException {
	  Log.i("Flow-GetNameinForeground","fetchToken");
      try {
